...
<body>
    ...
    <nav class="navbar">
        ...
        <ul class="nav-links">
            <li class="nav-items"><a href="#">Bro</a></li>
            <li class="nav-items"><a href="#">Studies And Learning Computer Science and IT</a></li>
            <li class="nav-items"><a href="#">Work Hard</a></li>
        ...
        <div class="right-container">
            ...
            <button class="sub-btn">Hello</button>
    ...
    <!-- ------------------ Recommendation ------------------ -->
    <h1 class="title">recommended you</h1>
        ...
        <div class="card-container">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <h6 class="des">Sailaja Hi ipsum dolor sit consectetur elit.</h6>
                    <button class="watchlist-btn">add to watchlist</button>
                </div>
            </div>
            <div class="card">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <h2 class="name">Ok  HelloComputer</h2>
